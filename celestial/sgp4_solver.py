...
class SGP4Solver():
    def __init__(self,
        ...
        self.start_jd, self.start_fr = sgp4.jday(starttime.year, starttime.month, starttime.day, starttime.hour, starttime.minute, starttime.second)
        ...
        for plane in range(0, self.number_of_planes):
            for node in range(0, self.nodes_per_plane):
                ...
                self.sgp4_solvers[unique_id].sgp4init(
                    ...
                    #epoch=
                    self.start_jd - 2433281.5, # epoch: days since 1949 December 31 00:00 UT
                    #bstar=
                    ...
                    #argpo=
                    np.radians(self.argpo), # argpo: argument of perigee (radians) -> zero for circular orbits
                    #inclo=
                ...
                e, r, d = self.sgp4_solvers[unique_id].sgp4(self.start_jd, self.start_fr)
