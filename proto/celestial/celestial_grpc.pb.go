...
const (
	Celestial_Register_FullMethodName = "/openfogstack.celestial.celestial.Celestial/Register"
	Celestial_Init_FullMethodName     = "/openfogstack.celestial.celestial.Celestial/Init"
	Celestial_Update_FullMethodName   = "/openfogstack.celestial.celestial.Celestial/Update"
	Celestial_Stop_FullMethodName     = "/openfogstack.celestial.celestial.Celestial/Stop"
)
...
func (c *celestialClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, Celestial_Register_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *celestialClient) Init(ctx context.Context, in *InitRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Celestial_Init_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *celestialClient) Update(ctx context.Context, opts ...grpc.CallOption) (Celestial_UpdateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Celestial_ServiceDesc.Streams[0], Celestial_Update_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *celestialClient) Stop(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Celestial_Stop_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Celestial_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Celestial_Register_FullMethodName,
	}
...
func _Celestial_Init_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Celestial_Init_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Celestial_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Celestial_Stop_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
